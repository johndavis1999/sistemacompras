...
$pedidoValues = $obj->getPedido($_GET['pedido_id']);
$pedidoItems = $obj->getPedidoItems($_GET['pedido_id']);
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-right">
					...
					<div class="form-group">
                        ...
                        <select class="form-select" name="" id="" aria-label="Disabled select example"  disabled>
                            <option value="<?php $pedidoValues['id']?>" selected>Pedido #<?php echo  $pedidoValues['id']?></option>
                        </select>
                        <input name="idPedido" type="hidden" value="<?= $pedidoValues['id']?>">
					</div>
                        ...
                        <div class="my-0 fw-normal">
                            <table class="table table-bordered table-hover" id="cotizacionItem">
                                ...
                                foreach ($pedidoItems as $pedidoItem) {
                                    ...
                                    $pedido_producto_cantidad = $pedidoItem["pedido_producto_cantidad"];
                                ?>
                                <tr>
                                    ...
                                    <td><input type="number" value="<?php echo $pedido_producto_cantidad;?>" name="cotizacion_producto_cantidad[]" id="cotizacion_producto_cantidad_<?php echo $count; ?>" class="form-control pedido_producto_cantidad" autocomplete="off" pattern="[0-9]" min="1" required></td>
                                </tr>
                                <?php } ?>
                            </table>
                        </div>
